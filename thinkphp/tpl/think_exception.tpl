...
<head>
    ...
    <link href="/book_manage.ico" rel="shortcut icon" />
...
<body>
<div class="mianBox">
    <img src="/static/error/yun0.png" alt="" class="yun yun0" />
    <img src="/static/error/yun1.png" alt="" class="yun yun1" />
    <img src="/static/error/yun2.png" alt="" class="yun yun2" />
    <img src="/static/error/bird.png" alt="" class="bird" />
    <img src="/static/error/san.png" alt="" class="san" />
    <div class="tipInfo">
        <div class="in">
            <div class="textThis">
                <h2>出错啦404！</h2>
